...
func InitOptionMap() {
	...
	common.OptionMap["ConfluxAPIEnabled"] = strconv.FormatBool(setting.ConfluxAPIEnabled)
	common.OptionMap["ConfluxAPIBaseURL"] = setting.ConfluxAPIBaseURL
	common.OptionMap["ConfluxAPIAppID"] = setting.ConfluxAPIAppID
	common.OptionMap["ConfluxAPIAppSecret"] = setting.ConfluxAPIAppSecret
	common.OptionMap["ConfluxAPIMchNo"] = setting.ConfluxAPIMchNo
	common.OptionMap["ConfluxAPIGatewayNo"] = setting.ConfluxAPIGatewayNo
	common.OptionMap["ConfluxAPINotifyURL"] = setting.ConfluxAPINotifyURL
	common.OptionMap["ConfluxAPIReturnURL"] = setting.ConfluxAPIReturnURL
	common.OptionMap["ConfluxAPICancelURL"] = setting.ConfluxAPICancelURL
	common.OptionMap["ConfluxAPICurrency"] = setting.ConfluxAPICurrency
	common.OptionMap["ConfluxAPIMinTopUp"] = strconv.Itoa(setting.ConfluxAPIMinTopUp)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "ConfluxAPIEnabled":
		setting.ConfluxAPIEnabled = value == "true"
	case "ConfluxAPIBaseURL":
		setting.ConfluxAPIBaseURL = value
	case "ConfluxAPIAppID":
		setting.ConfluxAPIAppID = value
	case "ConfluxAPIAppSecret":
		setting.ConfluxAPIAppSecret = value
	case "ConfluxAPIMchNo":
		setting.ConfluxAPIMchNo = value
	case "ConfluxAPIGatewayNo":
		setting.ConfluxAPIGatewayNo = value
	case "ConfluxAPINotifyURL":
		setting.ConfluxAPINotifyURL = value
	case "ConfluxAPIReturnURL":
		setting.ConfluxAPIReturnURL = value
	case "ConfluxAPICancelURL":
		setting.ConfluxAPICancelURL = value
	case "ConfluxAPICurrency":
		setting.ConfluxAPICurrency = value
	case "ConfluxAPIMinTopUp":
		setting.ConfluxAPIMinTopUp, _ = strconv.Atoi(value)
