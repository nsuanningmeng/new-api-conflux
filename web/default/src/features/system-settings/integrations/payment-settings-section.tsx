...
import {
  ConfluxAPISettingsSection,
  type ConfluxAPISettingsValues,
} from './confluxapi-settings-section'
...
type PaymentSettingsSectionProps = {
  ...
  confluxAPIDefaultValues: ConfluxAPISettingsValues
...
export function PaymentSettingsSection({
  ...
  return (
    <SettingsSection title={t('Payment Gateway')}>
      ...
      <ConfluxAPISettingsSection defaultValues={confluxAPIDefaultValues} />
    </SettingsSection>
  )
}
