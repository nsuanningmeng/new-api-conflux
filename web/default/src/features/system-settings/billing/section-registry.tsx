  ...
  },
  {
    ...
    build: (settings: BillingSettings) => (
      <PaymentSettingsSection
        ...
        confluxAPIDefaultValues={{
          ConfluxAPIEnabled: settings.ConfluxAPIEnabled ?? false,
          ConfluxAPIBaseURL: settings.ConfluxAPIBaseURL ?? '',
          ConfluxAPIAppID: settings.ConfluxAPIAppID ?? '',
          ConfluxAPIAppSecret: settings.ConfluxAPIAppSecret ?? '',
          ConfluxAPIMchNo: settings.ConfluxAPIMchNo ?? '',
          ConfluxAPIGatewayNo: settings.ConfluxAPIGatewayNo ?? '',
          ConfluxAPINotifyURL: settings.ConfluxAPINotifyURL ?? '',
          ConfluxAPIReturnURL: settings.ConfluxAPIReturnURL ?? '',
          ConfluxAPICancelURL: settings.ConfluxAPICancelURL ?? '',
          ConfluxAPICurrency: settings.ConfluxAPICurrency ?? 'USD',
          ConfluxAPIMinTopUp: settings.ConfluxAPIMinTopUp ?? 1,
        }}
        complianceDefaults={{
