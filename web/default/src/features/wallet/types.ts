...
export type WaffoPancakePaymentResponse = ApiResponse<
  ...
  | string
>
export type ConfluxAPIPaymentResponse = ApiResponse<
  | {
      payment_url?: string
      checkout_url?: string
      qr_code?: string
...
export interface TopupInfo {
  ...
  /** Whether ConfluxAPI topup is enabled */
  enable_confluxapi_topup?: boolean
  /** Minimum topup amount for ConfluxAPI */
  confluxapi_min_topup?: number
...
/**
 * ConfluxAPI payment request parameters
 */
export interface ConfluxAPIPaymentRequest {
  /** Topup amount */
  amount: number
}
