...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/cardshop/products", controller.GetCardShopProducts)
		apiRouter.GET("/cardshop/products/:id", controller.GetCardShopProduct)
		...
		// Waffo Pancake topup is intentionally disabled in this fork.
		// :env separates test vs prod URLs so the operator can register each
		// in Pancake's matching webhook slot; handler enforces env match.
		//apiRouter.POST("/waffo-pancake/webhook/:env", anonymousRequestBodyLimit, controller.WaffoPancakeWebhook)
		apiRouter.POST("/confluxapi/notify", anonymousRequestBodyLimit, controller.ConfluxAPINotify)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/confluxapi/amount", controller.RequestConfluxAPIAmount)
				selfRoute.POST("/confluxapi/pay", middleware.CriticalRateLimit(), controller.RequestConfluxAPIPay)
				selfRoute.POST("/cardshop/order", middleware.CriticalRateLimit(), controller.CreateCardShopOrder)
				selfRoute.GET("/cardshop/orders", controller.GetCardShopOrders)
				selfRoute.GET("/cardshop/orders/:id", controller.GetCardShopOrderDetail)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.POST("/cardshop/product", controller.AdminCreateProduct)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/confluxapi/pay", middleware.CriticalRateLimit(), controller.SubscriptionRequestConfluxAPIPay)
		}
